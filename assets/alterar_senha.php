...
<header>
    ...
    <section class="col-md-auto">   
        <div class="content-center" id="content-small" style="margin-top: 2rem">
            <form method="POST" onsubmit="if(typeof fSub !== 'undefined') return false; fSub = true;" action="processar/proc_alt_senha.php">
                <div class="row">
                    <div class="col-md-12">
                        <label for="usuario" style="font-weight: 700; text-align: center"><?php echo $_SESSION['nome_completo']; ?></label>
                    </div>
                    <div class="col-md-12">
                        <input type="password" name="nova_senha" placeholder="Digite sua nova senha">
                    </div>
                    <div class="col-md-12">
                        <input type="password" name="conf_senha" placeholder="Digite novamente a nova senha">
                    </div>
                    <div class="col-md-12">
                        <input type="submit" class="btn" name="SendAltSenha" value="Alterar Senha">
                    </div>
                </div>
            </form>
