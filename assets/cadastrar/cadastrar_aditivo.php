<?php
    ...
    if ($btnCadAditivo) {
        ...
        $result_aditivo = "INSERT INTO tbl_aditivo (id_contrato, num_aditivo, id_item, valor_aditivo, status_aditivo, id_usuario) VALUES (
        ...
        header("Location: cadastrar_aditivo.php");
    }
?>
            ...
            <form method="POST" onsubmit="if(typeof fSub !== 'undefined') return false; fSub = true;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 ">
                        ...
                        <input type="number" min="0.01" step="0.01" class="form-control" name="valor_aditivo"
                            id="valor_aditivo">
                    </div>
                    <div class="col-md-4">
                    </div>
