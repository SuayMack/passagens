...
if(isset($_POST['consulta'])){
    header("Location: ../consultar/consulta_contrato.php");
}
if(isset($_POST['menu'])){
...
<body>     
    ...
    <section class="col-md-auto">	
        <div class="content-center" id="container">
            ...
            <!-- Inicio Campos -->
                <h1>Contrato Editado</h1>
                <input type="hidden" name="id_contrato" value="<?php echo $row_msg_cont['id_contrato']; ?>">
                <fieldset>
                    ...
                    <div class="fieldset">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control" name="protocolo_contrato" id="protocolo_contrato"  maxlength="25" pattern="[0-9]{7}-[0-9]{2}.[0-9]{4}.[8]{1}.[1-6]{2}.[0-6]{4}$" data-mask="0000000-00.0000.8.16.6000" data-mask-selectonfocus="true" value="<?php echo $row_msg_cont['protocolo_contrato']; ?>" readonly>
                            </div>
                            <div class="col-sm-2">
                                <label id="date-side" for="pregao">Pregão Eletrônico</label>
                                <input type="text" class="form-control" name="pregao" id="pregao" maxlength="8"  value="<?php echo $row_msg_cont['pregao']; ?>" readonly>
                            </div>
                            <div class="col-sm-2">
                                <label id="date-side" for="diario_justica">Diário da Justiça</label>
                                <input type="text" class="form-control" name="diario_justica" id="diario_justica" maxlength="5" value="<?php echo $row_msg_cont['diario_justica']; ?>" readonly>
                            </div>
                            <div class="col-sm-3">
                                <label id="date-side" for="data_publicacao">Data de Publicação</label>
                                <input type="date" class="form-control" name="data_publicacao" id="data_publicacao" value="<?php echo $row_msg_cont['data_publicacao']; ?>" readonly>
                            </div>
                            <div class="col-sm-3">
                                <label id="date-side" for="vig_meses">Vigência em Meses</label>
                                <input type="number" class="form-control" name="vig_meses" id="vig_meses" value="<?php echo $row_msg_cont['vig_meses']; ?>" placeholder="12" readonly>
                            </div>
                            <div class="col-sm-3">
                                <label id="date-side" for="data_assinatura">Data de Assinatura</label>
                                <input type="date" class="form-control" name="data_assinatura" id="data_assinatura" value="<?php echo $row_msg_cont['data_assinatura']; ?>" readonly>
                            </div>
                            <div class="col-sm-3">
                                <label id="date-side" for="data_inicio">Data de Início</label>
                                <input type="date" class="form-control" name="data_inicio" id="data_inicio" value="<?php echo $row_msg_cont['data_inicio']; ?>" readonly>
                            </div>     
                            <div class="col-sm-3">
                                <label id="date-side" for="vigencia">Vigência Atual</label>
                                <input type="date" class="form-control" name="vigencia" id="date-side" value="<?php echo $row_msg_cont['vigencia']; ?>" readonly>
                            </div>
                        </div> 
                    </div>
                </fieldset>
                    ...
                    <div class="fieldset">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="contratada" id="contratada" value="<?php echo $row_msg_cont['contratada']; ?>" readonly>
                            </div>

                            <div class="col-md-3">
                                <label id="date-side" for="cnpj">CNPJ</label>
                                <input type="text" class="form-control" name="cnpj" id="cnpj" value="<?php echo $row_msg_cont['cnpj']; ?>" data-mask="00.000.000/0000-00" data-mask-selectonfocus="true" readonly>
                            </div>
                            <div class="col-md-3">
                                <label id="date-side" for="email_contratada">E-mail</label>
                                <input type="email" class="form-control" name="email_contratada" id="email_contratada" value="<?php echo $row_msg_cont['email_contratada']; ?>" readonly>
                            </div>
                            <div class="col-md-2">
                                <label id="date-side" for="telefone">Telefone</label>
                                <input type="text" class="telefone form-control" name="telefone" id="telefone" data-mask="(00) 0000-0000" data-mask-selectonfocus="true" value="<?php echo $row_msg_cont['telefone']; ?>" readonly>
                            </div>

                            <div class="col-md-4">
                                <label id="date-side" for="representante_legal">Representante Legal</label>
                                <input type="text" class="form-control" name="representante_legal" id="representante_legal" value="<?php echo $row_msg_cont['representante_legal']; ?>" readonly>
                            </div>
                            <div class="col-md-4 ">
                                <label id="date-side" for="cpf_representante">C.P.F.</label>
                                <input type="text" class="cpf form-control" name="cpf_representante" id="cpf_representante" value="<?php echo $row_msg_cont['cpf_representante']; ?>"
                                    data-mask="000.000.000-00" data-mask-selectonfocus="true" readonly>
                            </div>
                            <div class="col-md-4">
                                <label id="date-side" for="rg_representante">R.G.</label>
                                <input type="text" class="form-control" name="rg_representante" id="rg_representante" maxlength="14" value="<?php echo $row_msg_cont['rg_representante']; ?>" readonly>
                            </div>
                        </div>
                    </div>
                </fieldset>
                <div class="row">
                    <div class="col-md-6">
                        <input type ="submit" class="btn" name="editar" value ="Editar" formnovalidate></input>
                    </div>
                    <div class="col-md-6">
                        <input type ="submit" class="btn" name="menu" value ="Concluir" formnovalidate></input>
                    </div>
                </div>
                <input type="hidden" name="status_contrato" id="status_contrato" value="vigente">
            <!-- Fim Campos -->    
            </form>                                          
        </div>
    </section>
