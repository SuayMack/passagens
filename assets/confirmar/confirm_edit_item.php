...
if(isset($_POST['consulta'])){
    header("Location: ../consultar/consulta_item.php");
}
if(isset($_POST['menu'])){
...
<body>
    <?php
        ...
        $result_msg_cont = "SELECT * FROM tbl_item WHERE id_item = $id_item";
        ...
        <section class="col-md-auto">   
            <div class="content-center" id="container">
                <form method="POST" onsubmit="if(typeof fSub !== 'undefined') return false; fSub = true;">
                    <h1>Item de Contrato Editado</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="id_contrato" id="id_contrato" required="required" value="<?php echo $row_msg_cont['id_contrato']; ?>" readonly>
                        </div>
                        <!-- Select Descrição -->
                        <div class="col-md-7">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="valor_contratado" id="valor_contratado" class="form-control" value="<?php echo $row_msg_cont['valor_contratado']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="desconto_valor" id="desconto_valor" class="form-control" value="<?php echo $row_msg_cont['desconto_valor']; ?>" readonly>
                        </div>
                        <!-- Select Comissão Valor -->
                        <div class="col-md-3">
                            <label id="date-side" for="comissao_valor">Comissão Valor</label>   
                            <input type="text" name="comissao_valor" id="comissao_valor" class="form-control" value="<?php echo $row_msg_cont['comissao_valor']; ?>" readonly>
                        </div>
                        <!-- Select Desconto Percentual -->
                        <div class="col-md-3">
                            <label id="date-side" for="desconto_percentual">Desconto %</label>   
                            <input type="text" class="form-control" name="desconto_percentual" id="desconto_percentual" required="required" value="<?php echo $row_msg_cont['desconto_percentual']; ?>" readonly>
                        </div>
                        <!-- Select Comissão Percentual -->
                        <div class="col-md-3">
                            <label id="date-side" for="comissao_percentual">Comissão %</label>   
                            <input type="text" name="comissao_percentual" id="comissao_percentual" class="form-control" value="<?php echo $row_msg_cont['comissao_percentual']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">                        
                        <div class="col-md-3"> 
                            <label id="date-side" for="status_item">Status</label>
                            <input type="text" class="form-control" name="status_item" id="status_item" required="required" value="<?php echo $row_msg_cont['status_item']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
