                    ...
                    if(isset($_POST['search'])){
                        ...
                        if (strlen($valor) < 3) {
                            ...
                            if($_POST['tipo'] == "num_aditivo"){
                                $result_aditivo = "SELECT * FROM tbl_contrato 
                            ...
                            echo '
                                <tbody><form method="POST">    
                                    <tr>
                                        ...
                                        <th scope="row">'.$row_aditivo['status_aditivo'].'</td>
                            ';
                            if ($_SESSION['funcao'] == 1) {
                                switch ($row_aditivo['status_aditivo']) {
                                    case 'ativo':
                                        echo '<td id="td-edicao"><button name="btn_cancelar" style="color: white" value="'.$row_aditivo['id_aditivo'].'">Cancelar</button></td>';
                                        break;
                                    
                                    case 'cancelado':
                                        echo '<td id="td-edicao"><button name="btn_cancelar" style="color: white" value="'.$row_aditivo['id_aditivo'].'">Ativar</button></td>';
                                        break;
                                }
                            }
                            echo '
