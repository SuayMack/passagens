...
<head>
    ...
    <title>Pesquisa de Viagem</title>
    ...
    <section class="col-md-auto">
        <div class="content-center">
            ...
            <form method="POST" onsubmit="if(typeof fSub !== 'undefined') return false; fSub = true;">
                <div class="row">
                    <div class="col-md-9">
                        <label id="date-side">Pesquisa por protocolo</label>
                        <input type="text" name="valor" placeholder="Protocolo">
                    </div>
                    <div class="col-md-3">
                            ...
                            if ($resultado_viagem->rowCount() > 0) {
                                ...
                                while ($row_viagem = $resultado_viagem->fetch(PDO::FETCH_ASSOC)) {
                                    echo '
                                        <tbody>
                                            <tr>
                                                <td>' . $row_viagem['protocolo_compra'].'</td>
                                                <td>' . $row_viagem['evento'].'</td>
                                                <td>' . $row_viagem['requisitante'].'</td>
                                                <td>' . $row_viagem['status_viagem'].'</td>
                                                ';
                                                if ($_SESSION['funcao'] < 3) {
                                                    echo '
                                                <td id="td-edicao"><strong><a style="color:#123141" href="../editar/editar_viagem.php?id_viagem='.$row_viagem['id_viagem'].'">Editar</a></strong></td>
                                                ';
                                                } 
                                    echo'
                                            </tr>
