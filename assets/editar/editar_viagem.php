...
<section class="col-md-auto">
    <div class="content-center" id="container">
        <form method="POST" action="../processar/proc_edit_viagem.php">
            <h1>Viagem</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="  form-control" name="protocolo_compra" id="protocolo_compra" required="required" maxlength="25" pattern="[0-9]{7}-[0-9]{2}.[0-9]{4}.[8]{1}.[1-6]{2}.[0-6]{4}$" data-mask="0000000-00.0000.8.16.6000" data-mask-selectonfocus="true" value="<?php echo $row_msg_cont['protocolo_compra']; ?>">
                </div>
                <div class="col-md-8">
                    ...
                    placeholder="Opcional" value="<?php echo $row_msg_cont['requisitante']; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    placeholder="Descreva o evento ou motivo da viagem" required="required" value="<?php echo $row_msg_cont['evento']; ?>">
                </div>
                <div class="col-md-12">
                    ...
                    placeholder="Opcional" value="<?php echo $row_msg_cont['observacoes']; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <label id="date-side" name="status_viagem" for="status_viagem">Status</label>
                    <select class="custom-select" name="status_viagem">
                        <option selected><?php echo $row_msg_cont['status_viagem']; ?></option>
                        <?php 
                        if($row_msg_cont['status_viagem'] == "ativo"){
                            echo '<option name="status_viagem" value="cancelado">cancelado</option>';
                        }
                        else{
                            echo '<option name="status_viagem" value="ativo">ativo</option>';
                        }
                        ?>
                    </select>
                </div> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <input name="SendEditViagem" type="submit" class="btn" value="Editar">
                </div>
            </div>
            <!-- Fim Campos -->
        </form>
